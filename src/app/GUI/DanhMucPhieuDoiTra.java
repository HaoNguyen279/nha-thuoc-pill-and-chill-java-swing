...
public class DanhMucPhieuDoiTra extends JPanel implements ActionListener, MouseListener{
	...
	public JPanel createBotPanel() {
		...
		tblChiTietPhieuDoiTra.setRowHeight(35);
		tblChiTietPhieuDoiTra.setFont(new Font("Segoe UI", Font.PLAIN, 14));
		tblChiTietPhieuDoiTra.setFillsViewportHeight(true);
		tblChiTietPhieuDoiTra.setShowGrid(true);
		tblChiTietPhieuDoiTra.setGridColor(new Color(224, 224, 224));
		tblChiTietPhieuDoiTra.setSelectionMode(ListSelectionModel.SINGLE_SELECTION);
        tblChiTietPhieuDoiTra.setSelectionBackground(new Color(178, 223, 219));
        tblChiTietPhieuDoiTra.setSelectionForeground(Color.BLACK);
        ...
        btnXuatPhieuDoiTra.setBackground(new Color(46, 204, 113));
        btnXuatPhieuDoiTra.setForeground(Color.WHITE);
        btnXuatPhieuDoiTra.setFont(new Font("Segoe UI", Font.BOLD, 14));
        btnXuatPhieuDoiTra.setPreferredSize(new Dimension(200, 40));
        btnXuatPhieuDoiTra.setFocusPainted(false);
        btnXuatPhieuDoiTra.setBorderPainted(false);
        btnXuatPhieuDoiTra.setCursor(new Cursor(Cursor.HAND_CURSOR));
	...
	public JPanel createTopPanel() {
        ...
        tblPhieuDoiTra.setRowHeight(35);
        tblPhieuDoiTra.setFont(new Font("Segoe UI", Font.PLAIN, 14));
        tblPhieuDoiTra.setFillsViewportHeight(true);
        tblPhieuDoiTra.setShowGrid(true);
        tblPhieuDoiTra.setGridColor(new Color(224, 224, 224));
        tblPhieuDoiTra.setSelectionMode(ListSelectionModel.SINGLE_SELECTION);
        tblPhieuDoiTra.setSelectionBackground(new Color(178, 223, 219));
        tblPhieuDoiTra.setSelectionForeground(Color.BLACK);
        ...
        lblPhieuDoiTra.setFont(new Font("Segoe UI", Font.BOLD, 26));
        lblPhieuDoiTra.setForeground(PRIMARY_COLOR);
