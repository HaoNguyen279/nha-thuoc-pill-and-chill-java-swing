...
//    private final Color BG_COLOR = new Color(245, 245, 245);
    ...
    public XemChiTietDoanhThuTheoNhanVien(int thang, int nam) {
    ...
    public XemChiTietDoanhThuTheoNhanVien(int nam,String maNV) {
        setTitle("Danh Sách Hóa Đơn");
        setSize(1000, 600);
        setLocationRelativeTo(null);
        setDefaultCloseOperation(JFrame.DISPOSE_ON_CLOSE);
        ...
        // Tiêu đề frame
        JLabel lblTieuDe = new JLabel("DANH SÁCH HÓA ĐƠN NĂM "+ nam +" CỦA NHÂN VIÊN " +maNV, SwingConstants.CENTER);
        lblTieuDe.setFont(new Font("Segoe UI", Font.BOLD, 26));
        lblTieuDe.setForeground(new Color(0, 150, 136));
        lblTieuDe.setBorder(BorderFactory.createEmptyBorder(20, 0, 10, 0));
        add(lblTieuDe, BorderLayout.NORTH);
